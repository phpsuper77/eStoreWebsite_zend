...
function startUpload(filename) {
	if ( filename && initialSelect )
	{
		...
		liObj.setAttribute("src", "http://dev.video.ettrema.com/skins/videos/Big_Buck_Bunny_Trailer_480x270.png");
		liObj.setAttribute("url", "http://dev.video.ettrema.com" + pathID + filename);
		liObj.setAttribute("rel", "file");
		liObj.setAttribute("mtype", filename.substring(filename.lastIndexOf('.')+1, filename.length));
		liObj.innerHTML = '<ins class="jstree-icon">&nbsp;</ins><a class="" href="#"><ins class="jstree-icon">&nbsp;</ins>' + filename + '</a>';
