(function($){
	...
	$(document).ready( function(){
        jQuery('#enableUpload').on('click', function(){
            var price = jQuery('#image_price').val();
            var count = jQuery('.files .template-download').length;
            jQuery('#paypal-wrapper [name="AMT"]').val(price * count);
            jQuery('#totalAmount').val('$'+(price*count));
        });
