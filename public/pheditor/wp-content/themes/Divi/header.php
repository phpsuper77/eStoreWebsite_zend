...
<?php if ( is_user_logged_in() ): ?>
    #top-menu #menu-item-107 { display: none; }
    #top-menu #menu-item-112 { display: inline-block; }
<?php else: ?>
    #top-menu #menu-item-107 { display: inline-block; }
    #top-menu #menu-item-112 { display: none; }
<?php endif; ?>
</style>
</head>
<body <?php body_class(); ?>>
