...
class UploadHandler
{
    ...
    function __construct($options = null, $current_user_id, $initialize = true) {
	$upload_array = wp_upload_dir();
    $this->options = array(
            'script_url' => admin_url('admin-ajax.php'),
            'upload_dir' => $upload_array['basedir'].'/files/'.$current_user_id.'/',
            'upload_url' => $upload_array['baseurl'].'/files/'.$current_user_id.'/',
